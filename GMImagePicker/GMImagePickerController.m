    ...
    if (self = [super init])
    {
        ...
        if (self.videoRequestOptions == nil) {
            ...
            self.videoRequestOptions.progressHandler = ^void (double progress, NSError *__nullable error, BOOL *stop, NSDictionary *__nullable info)
            {
                ...
                [SVProgressHUD showProgress:progress status:[NSString stringWithFormat:@"Downloading %lu of %lu.", appendString ,self.currentIndex+1, [weakSelf.selectedAssets count]]];
